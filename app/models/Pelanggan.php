...
class pelanggan extends Model
{
      ...
      public function simpan()
      {
            ...
            $sql = "INSERT INTO tb_pelanggan (pel_id_gol, pel_id_user, pel_no, pel_nama, pel_alamat, pel_hp, pel_ktp, pel_seri, pel_meteran, pel_aktif) VALUES (:pel_id_gol, :pel_id_user, :pel_no, :pel_nama, :pel_alamat, :pel_hp, :pel_ktp, :pel_seri, :pel_meteran, :pel_aktif)";
      ...
      public function update()
      {
            ...
            $sql = "UPDATE tb_pelanggan SET pel_no=:pel_no, pel_nama=:pel_nama, pel_alamat=:pel_alamat, pel_hp=:pel_hp, pel_ktp=:pel_ktp, pel_seri=:pel_seri, pel_meteran=:pel_meteran, pel_aktif=:pel_aktif  WHERE pel_id=:pel_id";
            $stmt = $this->db->prepare($sql);
